...
namespace SnakeGame.Application.Handlers
{
    public class SnakeService
    {
        ...
        public void Add(BaseChar playerChar, PositionModel position, bool removeLast = true)
        {
            lock (_configurations)
            {
        ...
        public bool ChangeDirection(BaseChar playerChar, PositionModel newDirection)
        {
